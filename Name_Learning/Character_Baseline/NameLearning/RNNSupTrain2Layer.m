function [X,W,dWNorm] = RNNSupTrain2Layer(rep)
%% demo
% Input is:
% 1 0 0 0 1
% 0 1 0 1 0
...
% patternprob = [1 0 0 0 1; 0 1 0 1 0; 0 0 1 0 0; zeros(1,5),zeros(1,5);zeros(1,5)];
...
for i = 2:time-1
    ...
    prob(1:3) = inputnodeprob(:,i);
    prob(4:6) = inputnodeprob(:,i+1);
