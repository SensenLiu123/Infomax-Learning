function [X,W,dWNorm] = RNNCharMidLayerTrain(namelist, rep)


patternprob = max(0.001,namelist);patternprob = min(0.999, patternprob); % 

[numnode, patternnum]= size(patternprob);

numnode = numnode*4;%1 input  and 1 output, 54 middle layer, totally 108 
time = rep*patternnum;
